...
const expectedFrames = [
  { style: 'classic', label: 'Classic', slice: 115, cost: 100 },
  { style: 'natural', label: 'Natural', slice: 75, cost: 80 },
  { style: 'shabby', label: 'Shabby', slice: 120, cost: 90 },
  { style: 'elegant', label: 'Elegant', slice: 107, cost: 85 }
];
